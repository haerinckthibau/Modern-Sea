 ...
 */
function modernsea_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'modernsea_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.modernsea-front-page) .entry-title,
...
.colors-custom .modernsea-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.modernsea-front-page .panel-content .recent-posts article,
...
.colors-custom.modernsea-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'modernsea_custom_colors_css', $css, $hue, $saturation );
}
